...
public class PrintResult {
    ...
    public void printMenuList(List<com.section2.javaconfig.MenuDTO> menuList) {
        for (com.section2.javaconfig.MenuDTO menu : menuList) {
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch (errorCode) {
            ...
            case "delete" : errorMessage = "매뉴 삭제에 실패하였습니다."; break;
        }
